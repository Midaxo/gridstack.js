 ...
 * @preserve
*/
!function(a){if("function"==typeof define&&define.amd)define(["jquery","underscore"],a);else if("undefined"!=typeof exports){try{jQuery=require("jquery")}catch(b){}try{_=require("underscore")}catch(b){}a(jQuery,_)}else a(jQuery,_)}(function(a,b){
